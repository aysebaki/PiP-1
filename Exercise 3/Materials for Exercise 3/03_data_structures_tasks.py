...
b = a + (5,)   #(1, 2, 3, 4, 5)
#[start:end:step]
#[start of the seq:end of the seq: 1]
c = (0,) + b[1:]
...
# extract every third element starting at index 50 until index 70 (excluding) and store it
# in a new list. Use slicing to solve this task.

numbers = list(range(100))
sub_numbers = a[50:70:3]     # [start=50 : stop=70  : step=3]
...
flat = nl[:3] + nl[3][:2] + nl[3][2] + nl[3][3:] + nl[-3:]
...
sup = nd["sale department"] ["e2"] ["supervisor"]
name_sup = nd["sale department"][sup]["name"]
